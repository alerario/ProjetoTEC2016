...
public class ChatView implements Serializable {
    ...
    public void login() throws InstantiationException, IllegalAccessException {
        org.primefaces.context.RequestContext requestContext = org.primefaces.context.RequestContext.getCurrentInstance();
    ...
    public void disconnect() {
       ...
       org.primefaces.context.RequestContext.getCurrentInstance().update("form:users");
